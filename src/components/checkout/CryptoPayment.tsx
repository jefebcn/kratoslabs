...
import { Bitcoin, Check, Copy, Clock, Send } from "lucide-react";
...
function CopyRow({ address }: { address: string }) {
  ...
  async function copy() {
    try {
      ...
      /* clipboard non disponibile: l'indirizzo resta selezionabile a mano */
    }
  }
